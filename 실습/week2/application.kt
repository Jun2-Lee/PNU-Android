...
enum class BeerType{LIGHT_LARGER,LIGHT_HYBRID,BOCK,AMBER_HYBRID,FRUIT}
...
fun Beer.change_price(cost:Int){this.cost = cost}
fun Wine.euro_to_won(operation: (Int,Int) -> Int){
    var won:Int = operation(cost,1350)
...
fun main(){
    ...
    var wine1 = Wine("Carbernet", WineType.RED,10)
